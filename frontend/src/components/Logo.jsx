...
export function Logo({ className = "" }) {
  return (
    <Link href="/" className={`flex items-center space-x-2 group ${className}`}>
      <div className="w-8 h-8 bg-[#4F46E5] rounded-lg flex items-center justify-center transition-transform duration-200 group-hover:scale-110">
      ...
      <span className="text-xl font-display font-bold text-gray-900">Mancrel</span>
    </Link>
  )
}
