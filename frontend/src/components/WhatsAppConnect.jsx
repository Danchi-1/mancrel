            ...
            <div className="flex-1 max-w-md">
              ...
              <div className="space-y-6 mb-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Create a Free Account</p>
                    <p className="text-sm text-gray-500 mt-1">
                      Go to <a href="https://twilio.com" target="_blank" rel="noopener noreferrer" className="text-[#4F46E5] hover:underline inline-flex items-center gap-1">twilio.com <ExternalLink className="w-3 h-3"/></a> and sign up.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
